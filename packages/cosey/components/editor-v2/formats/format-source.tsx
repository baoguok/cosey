...
import { Node, Selection } from 'slate-vue3/core';
...
export default defineComponent({
  setup() {
    ...
    const onConfirm = () => {
      ...
      if (selection) {
        const anchorNode = Node.getIf(editor, selection.anchor.path);
        const focusNode = Node.getIf(editor, selection.focus.path);
