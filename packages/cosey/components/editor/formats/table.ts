...
class TableRow extends Container {
  ...
  declare children: Parchment.LinkedList<TableCell>;
  declare next: this | null;
...
class TableBody extends Container {
  ...
  declare children: Parchment.LinkedList<TableRow>;
}
...
class TableContainer extends Container {
  ...
  declare children: Parchment.LinkedList<TableBody>;
...
TableContainer.allowedChildren = [TableBody, Caption];
...
Caption.requiredContainer = TableContainer;
...
export { TableCell, TableRow, TableBody, TableContainer, Caption, tableId };
