...
export const generateNeutralColorPalettes: GenerateNeutralColorMap = (
  ...
  return {
    ...
    colorFill: getSolidColor(colorBgBase, 15),
    colorFillSecondary: getSolidColor(colorBgBase, 6),
    colorFillTertiary: getSolidColor(colorBgBase, 4),
    colorFillQuaternary: getSolidColor(colorBgBase, 2),
