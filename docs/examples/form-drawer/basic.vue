<template>
  <el-button type="primary" @click="visible = true">新建表单</el-button>

  <co-form-drawer v-model="visible" title="创建表单">
    <co-form :model="formModel" label-position="top" :submit="onSubmit">
      <co-form-group>
        <co-form-item
